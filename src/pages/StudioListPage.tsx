    ...
    <section className=" w-full h-screen flex flex-col mt-16 ml-8">
      <ul className="w-full flex flex-col">
        ...
        <li className="text-2xl">
          <p>참여중인 스튜디오</p>
          <div className="flex my-4">
            <a className="border border-dotted border-4 border-gray-600 image-select-size flex items-center justify-center">
              + 방 참가
            </a>
            <div className="relative flex flex-col justify-around items-center">
              <p className="absolute px-3 top-4 right-4 bg-green-500 text-center text-lg border rounded-xl text-white">
              ...
              />
              <div className="flex justify-around w-full px-4">
                <div className="flex items-center justify-center">studio2</div>
                <p>|</p>
                <p>D-8</p>
              </div>
            </div>
            <div className="relative flex flex-col justify-around items-center">
              ...
              />
              <div className="flex justify-around w-full px-4">
                <div className="flex items-center justify-center">studio3</div>
                <p>|</p>
                <p>D-4</p>
              </div>
            </div>
