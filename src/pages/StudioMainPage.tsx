            ...
            <div className="flex my-4">
              <div className="relative flex flex-col justify-around items-center mx-2">
                ...
                <div className="flex justify-around w-full px-4">
                  <div className="flex items-center justify-center">은쮸</div>
                </div>
              </div>
              <div className="relative flex flex-col justify-around items-center mx-2">
                <img
                ...
                />
                <div className="flex justify-around w-full px-4">
                  <div className="flex items-center justify-center">연쮸</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="px-4">
            ...
            <div className="flex my-4">
              <div className="relative flex flex-col justify-around items-center mx-2">
                ...
                />
                <div className="flex justify-around w-full px-4">
                  <div className="flex items-center justify-center">유꼉</div>
                </div>
              </div>
              <div className="relative flex flex-col justify-around items-center mx-2">
                <img
                ...
                />
                <div className="flex justify-around w-full px-4">
                  <div className="flex items-center justify-center">뗜제</div>
                </div>
              </div>
            </div>
          </div>
